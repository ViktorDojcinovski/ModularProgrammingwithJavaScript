App_Core.registerComponent("mainPageContainer", "content", function(
    sandBox) {
    var contentImagesArray = App_GlobalData.getIndexContentAreaImagesArray(),
        favCookieName = App_GlobalData.getFavCookieName(),
    ...
    return {
        ...
        handelFavouritesClick: function() {
            ...
            try {
                ...
                favouritesHTMLStr = App_GlobalData.getFavouritesHTMLTxt();
            } catch (e) {
                // get the value of page object defintion from storage
                favouritesPageObjDef = sandBox.getValueForKeyAsObjectFromStorage(
                    App_GlobalData.getFavouritesPageObjDefID()
                );
                if (!favouritesPageObjDef) {
                    favouritesPageObjDefID = App_GlobalData.getFavouritesPageObjDefID();
