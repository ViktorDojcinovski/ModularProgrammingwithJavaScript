var App_GlobalData = App_GlobalData || null;
var App_PageSections = (function(mainModule, subModule) {
    ...
    pageSections.headerContainerDefObj = {
        sectionHTML: '<div id="logoDiv" class="logo_titleClass" >' +
            '<a href="#" id="siteLogo"><img src="Images/AppLogo.png" alt="Company Logo" style="max-height:100%;"></a>' +
    ...
    if (!App_GlobalData) {
        App_GlobalData = mainModule; // reset App_GlobalData in case an empty object was passed in    
    }
    return pageSections;
})(App_GlobalData || {}, App_PageSections || {}); // using Asynchronous sub-module
// Using loose augmentation to augment App_GlobalData
// and tight augmentation to augment App_PageSections
...
})(App_GlobalData || {}, App_PageSections);