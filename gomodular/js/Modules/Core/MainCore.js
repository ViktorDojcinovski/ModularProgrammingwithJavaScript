var App_Core = (function(mainCore) {
    var $ = null,
        registeredModules = [],
    ...
    (function Core_initialize() {
        ...
        try {
            ...
            mainCore.jQuery = $ = App_Base.getBaseModule();
        } catch (e) {
            if (mainCore.debug) {
    ...
    mainCore.loadPageDefinitionsFileAndCallBack = function(callbackFunc) {
        var pageDefinitionsFileName = App_GlobalData.getPageDefinitionsFileName(),
            pageDefinitionsFilePath = App_GlobalData.getPageDefinitionsFilePath();
    ...
    mainCore.runAllUnitTests = function() {
        if (typeof App_Core.AppTester !== 'undefined') {
            try {
                App_Core.AppTester.runAllUnitTests();
            } catch (e) {
    ...
    return mainCore;
})(App_Core || {}); // using loose augmentation of App_Core
// DOM related functionality
var App_Core = (function(Core) {
    var $ = Core.jQuery;
    ...
    return Core;
})(App_Core); // using tight augmentation
